...
class MemberServiceTest {
    ...
    fun `should update profile and emit update event`() {
        ...
        val result = memberService.updateProfile(
    ...
    fun `should change status and emit lifecycle`() {
        ...
        val result = memberService.changeStatus(
    ...
    private fun setId(entity: MemberAccount, value: Long) {
