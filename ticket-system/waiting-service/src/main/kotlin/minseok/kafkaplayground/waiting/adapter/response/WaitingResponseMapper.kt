...
fun WaitingTicket.toResponse(): WaitingTicketResponse = WaitingTicketResponse(
    id = id,
    queueCode = queueCode,
    memberId = memberId,
    status = status.name,
...
fun WaitingTicketStatus.toResponse(): WaitingStatusResponse = WaitingStatusResponse(
    ticketId = ticketId,
    queueCode = queueCode,
    memberId = memberId,
    status = status,
